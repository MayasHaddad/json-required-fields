var dataCheck = require('./index.js')
...
var tests = [
	...
	function() {
		assert.deepEqual(
			dataCheck.checkReqHasFields(
					{firstname: 'John', address: { 'street': {'oldName': 'honolulu'} } }, ['firstname', { 'address': [ { 'street': ['oldName', 'newName'] } ] } ], ''
			),
	...
	function() {
		assert.deepEqual(
			dataCheck.checkReqHasFields(
					...
					}, ['firstname', { 'this': [ { 'path': ['oldName', {'is' : [ 'missing', 'nothis' ]}] } ] } ], ''
			),
